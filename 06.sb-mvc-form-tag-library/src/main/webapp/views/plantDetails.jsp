...
<body class="bg-info">
	<h2 class="text-center text-light">Plant Details</h2>
	<a href="save" class="text-center"><button type="button" class="btn btn-outline-success">+Add Plant</button></a>
	<table
		...
		<tbody>
			<c:forEach items="${allPlants}" var="plant">
				<tr>
					...
					<td>${plant.contact}</td>
					<td><a href="delete?plantId=${plant.plantId	}">
